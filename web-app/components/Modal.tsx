...
function Modal({setModal}:IModalProps) {
  ...
  return (
    <div className='h-[100vh] flex items-center justify-center w-full overflow-hidden absolute top-0 bg-mainColor text-white'>
      <img src="/icons/cross.svg" alt="cross" onClick={hideModal} className='absolute bg-white h-8 rounded-full p-1 cursor-pointer top-[22vh] left-[87vw] lg:left-[74vw] ' />
      <div className=' h-auto sm:h-[50vh] w-[80vw] lg:w-[50vw] flex flex-col items-center sm:flex-row bg-fadedColor rounded-lg overflow-hidden'>
        ...
        <div className='w-[50%] flex flex-col items-center justify-center'>
          ...
          <label htmlFor="profile" className='mt-4 bg-gray-100 p-2 mb-4 cursor-pointer rounded-full'><img src="/icons/addImage.svg" alt="add image" className='h-6' /></label>
        </div>
      </div>
    </div>
  )
